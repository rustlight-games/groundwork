...
//! means zero. See [`terrain_bench::compare`].
//!
...
use glam::Vec3;
use terrain_bake::bake::{BakeParams, TILE_PIXELS, bake, bake_grid};
use terrain_bake::surface::resample;
use terrain_bench::compare::{self, Similarity, Verdict};
use terrain_bench::{Measurement, Report, SEEDS, Unit};
