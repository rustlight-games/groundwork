...
//!
//! Everything here is therefore single-threaded, and [`terrain_bake::bake::bake`] is
//! measured at [`terrain_bake::bake::TILE_PIXELS`] rather than at some convenient
...
/// `compare::detail`, and
/// [`terrain_bake::bake::tests::a_coarse_page_agrees_with_a_minified_fine_one`].
