...
//! [`terrain_bake::bake::Passes`] is the structure, exported beside the picture.
...
use terrain_bake::bake::{BakeParams, Macro, Passes, cast_shadows, lay_floor, resolve_passes};
use terrain_bake::painter::Painter;
use terrain_bake::surface::Surface;
use terrain_cycles::cycles::{self, CyclesScene, RenderSettings};
