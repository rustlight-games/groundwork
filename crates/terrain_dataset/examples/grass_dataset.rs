...
//! beside it. See [`terrain_dataset::dataset`] for why each of those three things is a
...
//! [`terrain_dataset::dataset::generate`], where a second entry point can reach them.
//!
