...
pub fn cycles_params(params: &BakeParams) -> BakeParams {
...
impl PlatePlan {
    ...
    pub fn resolve(request: &PlateRequest, params: &BakeParams) -> Self {
...
mod tests {
    ...
    fn a_close_up_needs_no_tiling() {
        ...
        let plan = PlatePlan::resolve(&request, &cycles_params(&BakeParams::default()));
    ...
    fn a_wide_view_is_tiled_rather_than_thinned() {
        ...
        // to 0.22.
        let params = cycles_params(&BakeParams::default());
